      ...
      <div className="flex items-center gap-1">
        ...
        {onOpenAdmin && (
          <button
            ...
            className="shrink-0 w-9 h-9 rounded-lg flex items-center justify-center text-muted hover:bg-surfaceAlt hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 transition"
          >
            <Settings size={17} />
          </button>
        )}
